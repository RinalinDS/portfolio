...
const socialNetworkProjectTech =
  'Technologies: JavaScript, TypeScript, React, Redux, Redux-thunk, Redux-form, Axios';

const todolistProjectDescription =
  'SPA for managing to-do lists and their items. ' +
        ...
        <div className={styles.projectsContainer}>
          ...
          <div className={styles.projects}>
            <Project
              ...
              style={todolistStyle}
              title={'TODOLIST'}
              description={todolistProjectDescription}
              tech={todolistProjectTech}
            />
            <Project
              ...
              description={socialNetworkProjectDescription}
              tech={socialNetworkProjectTech}
            />
            <Project
              ...
              description={cardProjectDescription}
              tech={cardsProjectTech}
            />
            <Project
              ...
              style={weatherStyle}
              title={'Weather App'}
              description={weatherProjectDescription}
              tech={weatherProjectTech}
            />
          </div>
        </div>
      </div>
